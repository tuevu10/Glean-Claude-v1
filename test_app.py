...
class AppTests(unittest.TestCase):
    def test_priority_card_opens_details_tab(self):
        ...
        self.assertEqual(app.selectbox[0].value, "CUST-02")
    ...
    def test_dashboard_filters_details_and_thresholds(self):
        with patch.dict(os.environ, {"OPENAI_API_KEY": ""}):
            ...
            self.assertEqual(app.selectbox[0].value, "CUST-03")
            ...
            app.selectbox[0].set_value("CUST-03").run()
    ...
    def test_manual_navigation_survives_stale_row_selection(self):
        ...
        app.selectbox[0].set_value("CUST-01").run()
        self.assertEqual(app.selectbox[0].value, "CUST-01")
        app.toggle[0].set_value(False).run()
        self.assertEqual(app.selectbox[0].value, "CUST-01")
        self.assertFalse(app.exception)
